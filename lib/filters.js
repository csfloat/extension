class Filter {
    constructor(expression, colour, isGlobal, filters) {
        ...
        this.validExpressionVars = ['float', 'seed', 'minfloat', 'maxfloat', 'minwearfloat', 'maxwearfloat'];
...
class Filters {
    ...
    _saveFilters() {
        ...
        let syncFilters = {};
        const localFilters = this.filters.filter((f) => !f.isGlobal);
        const globalFilters = this.filters.filter((f) => f.isGlobal);
